---
title: "Incompetence and disreputable conduct that may result in a disciplinary proceeding"
code: "3.1.3.a"
part: 3
...
forms: []
related: ["3.1.3.b", "3.1.4.b", "3.1.1.a", "3.4.3.b", "3.1.3.c", "3.1.3.d", "3.1.2.a"]
changelog:
...
| Item | Value |
|---|---|
| Categories listed in § 10.51(a) | {fig:circ230.10_51.categories} |
| Maximum monetary penalty | {fig:circ230.monetary_penalty.cap} |
...
<p><strong>The § 10.51 list is not exhaustive.</strong> It reads "includes, but is not limited to".</p>
<p><strong>Section 10.52 is a separate door.</strong> A willful violation of any rule in the part is sanctionable even if nothing on the § 10.51 list happened.</p>
<p><strong>Willfulness is not always required.</strong> Sections 10.34, 10.35, 10.36 and 10.37 can be violated recklessly or through gross incompetence and still be sanctionable. Section 10.33 is excluded from § 10.52 altogether.</p>
<p><strong>Your own returns count.</strong> Section 10.51(a)(6) reaches the practitioner's personal filing and payment.</p>
<p><strong>Discipline elsewhere travels.</strong> Disbarment or suspension by a state board or another federal agency is itself § 10.51(a)(10) conduct.</p>
<p><strong>A destroyed report does not close a case.</strong> Section 10.53(d) bars using the report, not the proceeding.</p>
</div>
...
**1. A practitioner is suspended from practice by their state accountancy board. Under Circular 230 this is:**
(A) Irrelevant, since the state has no authority over IRS practice (B) Disreputable conduct under § 10.51(a)(10) in its own right (C) Sanctionable only if the underlying conduct involved federal tax (D) Grounds for automatic disbarment
*Answer: B. Discipline by a state authority, a federal court of record or a federal agency is itself listed conduct.*
...
*Answer: B. Section 10.53(b) allows an oral report from a person other than an IRS employee; the employee reduces it to writing.*
