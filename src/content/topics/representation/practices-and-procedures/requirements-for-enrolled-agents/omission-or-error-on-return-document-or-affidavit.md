---
title: "Omission or error on return, document, or affidavit"
code: "3.1.2.b"
part: 3
domain: "Practices and Procedures"
section: "Requirements for Enrolled Agents"
description: "What Circular 230 section 10.21 requires when a practitioner discovers a client's error: advise the client of the fact and the consequences, and nothing more."
status: review
taxYear: 2026
...
forms: ["1040-X"]
related: ["3.1.2.a", "3.1.2.f", "3.1.3.d"]
changelog:
...
<p><strong>The duty runs to the client, not to the IRS.</strong> There is no disclosure obligation.</p>
<p><strong>Both limbs are required.</strong> The fact <em>and</em> the consequences under the Code and regulations.</p>
<p><strong>There is no duty to amend or to withdraw.</strong> Those follow from other rules, if at all.</p>
<p><strong>Assisting the continuing noncompliance is a different offence</strong> — § 10.51(a)(7), § 10.34(a), IRC § 6694.</p>
<p><strong>Disclosing without authority is criminal.</strong> IRC § 7216.</p>
<p><strong>Document the advice.</strong> Unrecorded advice cannot be shown to have been given.</p>
</div>
