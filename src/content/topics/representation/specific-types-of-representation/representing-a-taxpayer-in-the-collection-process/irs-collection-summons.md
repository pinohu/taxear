---
title: "IRS Collection Summons (e.g., purposes)"
code: "3.3.1.l"
part: 3
...
authorities:
  ...
  - { type: IRC, ref: "§ 7605", title: "Time and place of examination" }
  - { type: IRC, ref: "§ 7609", title: "Special procedures for third-party summonses" }
  - { type: IRC, ref: "§ 7610", title: "Fees and costs for witnesses" }
...
**Third-party contacts generally need advance warning.** Separately from the summons power, the IRS may not contact anyone other than the taxpayer about determining or collecting their liability unless it has given the taxpayer notice {fig:summons.thirdparty_contact_notice}, and only where there is an actual intent to make such contacts (IRC § 7602(c)(1)).
...
| Item | Value |
|---|---|
| Date fixed for appearance | {fig:summons.appearance_days} |
| Notice to the third party | {fig:summons.thirdparty_notice} |
| Proceeding to quash | {fig:summons.quash_window} |
| Notice before third-party contacts | {fig:summons.thirdparty_contact_notice} |
...
**1. An IRS summons may be issued for all of the following except:**
(A) Ascertaining the correctness of a return (B) Making a return where none has been made (C) Collecting a tax liability (D) Compelling a taxpayer to waive the statute of limitations
*Answer: D. The four purposes are in IRC § 7602(a).*

**2. A third party summoned for a taxpayer's records. The taxpayer's proceeding to quash must be begun:**
(A) Within 20 days after the notice is given (B) Within 30 days of the summons (C) Before the date fixed for production (D) Within 10 days of service
*Answer: A. IRC § 7609(b)(2)(A), and a copy of the petition must be mailed to the person summoned and the IRS in the same period.*
...
*Answer: B. The summons is administrative to issue and judicial to enforce.*
