...
- Multiple-choice questions: every page in all three parts now carries them, and every Part 3 answer carries a one-sentence reason — the 121 items that once answered with a letter and citation only are done.
